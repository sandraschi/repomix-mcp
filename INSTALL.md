...
4. Start the server:
   ...
   uv run python -m repomix_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn repomix_mcp.server:app --port 10866
   ```
5. Open `http://localhost:10866` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/repomix-mcp/issues) |
