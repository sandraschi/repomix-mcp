...
const BACKEND_NAME: &str = "repomix-mcp-backend.exe";
const BACKEND_PORT: u16 = 10866;
const BACKEND_TAG: &str = "repomix-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "REPOMIX_MCP_PORT";
const ENV_HOST: &str = "REPOMIX_MCP_HOST";
const ENV_TAURI: &str = "REPOMIX_MCP_TAURI";
